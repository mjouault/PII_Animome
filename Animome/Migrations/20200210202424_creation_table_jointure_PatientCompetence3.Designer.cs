...
namespace Animome.Migrations
{
    ...
    [Migration("20200210202424_creation_table_jointure_PatientCompetence3")]
    partial class creation_table_jointure_PatientCompetence3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animome.Models.Prerequis", b =>
                {
                    ...
                    b.Property<int?>("LaCompetenceId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("LaCompetenceId");
            ...
            modelBuilder.Entity("Animome.Models.Prerequis", b =>
                {
                    b.HasOne("Animome.Models.Competence", "LaCompetence")
                        .WithMany("LesPrerequis")
                        .HasForeignKey("LaCompetenceId");
                });
