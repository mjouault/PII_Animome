...
namespace Animome.Migrations
{
    ...
    [Migration("20200220135310_Reconstruction totale de la BDD2")]
    partial class ReconstructiontotaledelaBDD2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Animome.Models.PatientCompetence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Animome.Models.SuiviCompetencePrerequis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("SuiviCompetencePrerequis");
                });

            modelBuilder.Entity("Animome.Models.SuiviCompetencePrerequisNiveau", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("SuiviCompetencePrerequisId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SuiviCompetencePrerequisId");

                    b.ToTable("SuiviCompetencePrerequisNiveau");
                });

            modelBuilder.Entity("Animome.Models.SuiviCompetencePrerequisNiveauExercice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NbFaits")
                        .HasColumnType("int");

                    b.Property<int?>("SuiviCompetencePrerequisNiveauId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SuiviCompetencePrerequisNiveauId");

                    b.HasIndex("ValideurId");

                    b.ToTable("SuiviCompetencePrerequisNiveauExercice");
                });
            ...
            modelBuilder.Entity("Animome.Models.CompetencePrerequis", b =>
                {
                    b.HasOne("Animome.Models.Competence", "Competence")
                        .WithMany("LesCompetencesPrerequis")
            ...
            modelBuilder.Entity("Animome.Models.DomaineUser", b =>
                {
                    b.HasOne("Animome.Models.Domaine", "Domaine")
                        .WithMany("LesDomaineUsers")
                        .HasForeignKey("DomaineId");

                    b.HasOne("Animome.Models.ApplicationUser", "User")
                        .WithMany("LesDomaineUsers")
            ...
            modelBuilder.Entity("Animome.Models.Suivi", b =>
                {
                    b.HasOne("Animome.Models.Exercice", "DernierExoModifie")
                        .WithMany()
            ...
            modelBuilder.Entity("Animome.Models.SuiviApplicationUser", b =>
                {
                    b.HasOne("Animome.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("LesSuivisApplicationUsers")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("Animome.Models.Suivi", "Suivi")
                        .WithMany("LesSuiviApplicaitonUsers")
            ...
            modelBuilder.Entity("Animome.Models.SuiviCompetencePrerequisNiveau", b =>
                {
                    b.HasOne("Animome.Models.Niveau", "Niveau")
                        .WithMany("LesSuiviCompetencePrerequisNiveaux")
                        .HasForeignKey("NiveauId");

                    b.HasOne("Animome.Models.SuiviCompetencePrerequis", "SuiviCompetencePrerequis")
                        .WithMany("LesNiveaux")
                        .HasForeignKey("SuiviCompetencePrerequisId");
                });

            modelBuilder.Entity("Animome.Models.SuiviCompetencePrerequisNiveauExercice", b =>
                {
                    b.HasOne("Animome.Models.Exercice", "Exercice")
                        .WithMany("LesSuiviCompetencePrerequisNiveauExercices")
                        .HasForeignKey("ExerciceId");

                    b.HasOne("Animome.Models.SuiviCompetencePrerequisNiveau", "SuiviCompetencePrerequisNiveau")
                        .WithMany("LesExercices")
                        .HasForeignKey("SuiviCompetencePrerequisNiveauId");
